      ...
      <>
        ...
        <section className="py-24">
          <div className="mx-auto max-w-xl px-4 text-center">
            ...
            <Button variant="brown" size="lg" className="mt-8" onClick={() => setSubmitted(false)}>
              Submit Another Form
            </Button>
          </div>
        </section>
  ...
  return (
    <>
      <PageHero
        ...
        subtitle="Complete the form below to begin your Teresian journey."
      />
          ...
          <form onSubmit={onSubmit} className="space-y-8">
              ...
              <fieldset className="rounded-2xl border bg-card p-7 shadow-soft">
                ...
                <div className="mt-4 grid gap-4 sm:grid-cols-2">
                  <Field id="lname" label="Last Name" required>
                    <Input id="lname" required maxLength={60} />
                  </Field>
                  <Field id="fname" label="First Name" required>
                    <Input id="fname" required maxLength={60} />
                  </Field>
                  <Field id="mname" label="Middle Name">
                    <Input id="mname" maxLength={60} />
                  </Field>
                  <Field id="suffix" label="Suffix (Jr., III)">
                    <Input id="suffix" maxLength={10} />
                  </Field>
                  <Field id="dob" label="Date of Birth" required>
                    <Input id="dob" type="date" required />
                  </Field>
                  <Field id="pob" label="Place of Birth">
                    <Input id="pob" maxLength={120} />
                  </Field>
                  ...
                  <Field id="religion" label="Religion">
                    <Input id="religion" maxLength={60} />
                  </Field>
                  <Field id="lrn" label="Learner Reference No. (LRN)">
                    <Input id="lrn" maxLength={20} inputMode="numeric" />
                  </Field>
                  <Field id="nationality" label="Nationality">
                    <Input id="nationality" maxLength={60} defaultValue="Filipino" />
                  </Field>
                </div>
                <div className="mt-4">
                  <Field id="address" label="Home Address" required>
                    <Textarea id="address" required maxLength={250} rows={2} />
                  </Field>
                </div>
              </fieldset>
            </Reveal>
            ...
            <Reveal delay={120}>
              <fieldset className="rounded-2xl border bg-card p-7 shadow-soft">
                ...
                <div className="mt-4 grid gap-4 sm:grid-cols-2">
                  ...
                  <Field id="sy" label="School Year">
                    <Input id="sy" defaultValue="2026–2027" maxLength={20} />
                  </Field>
                  <Field id="prevschool" label="Previous School">
                    <Input id="prevschool" maxLength={150} />
                  </Field>
                  <Field id="prevschooladdr" label="Previous School Address">
                    <Input id="prevschooladdr" maxLength={150} />
                  </Field>
                </div>
              </fieldset>
            </Reveal>
            ...
            <Reveal delay={160}>
              <fieldset className="rounded-2xl border bg-card p-7 shadow-soft">
                ...
                <div className="mt-4 grid gap-4 sm:grid-cols-2">
                  <Field id="father" label="Father's Name">
                    <Input id="father" maxLength={120} />
                  </Field>
                  <Field id="father_occ" label="Father's Occupation">
                    <Input id="father_occ" maxLength={120} />
                  </Field>
                  <Field id="mother" label="Mother's Name">
                    <Input id="mother" maxLength={120} />
                  </Field>
                  <Field id="mother_occ" label="Mother's Occupation">
                    <Input id="mother_occ" maxLength={120} />
                  </Field>
                  <Field id="guardian" label="Guardian (if applicable)">
                    <Input id="guardian" maxLength={120} />
                  </Field>
                  <Field id="relation" label="Relationship to Student">
                    <Input id="relation" maxLength={60} />
                  </Field>
                  <Field id="contact" label="Contact Number" required>
                    <Input id="contact" required maxLength={20} inputMode="tel" />
                  </Field>
                  <Field id="pemail" label="Email Address" required>
                    <Input id="pemail" type="email" required maxLength={255} />
                  </Field>
                </div>
              </fieldset>
            </Reveal>
