  ...
  head: () => ({
    meta: [
      { title: "About STSN | St. Theresa's School of Novaliches" },
      {
        name: "description",
        content:
          "Established in 1989, St. Theresa's School of Novaliches has grown into a full Catholic basic-education institution committed to faith, excellence, and Filipino values.",
      },
  ...
  return (
    <>
      <PageHero
        eyebrow="Who We Are"
        title="About STSN"
        subtitle="A Christian, Filipino institution forming learners since 1989."
      />
        ...
        <div className="mx-auto grid max-w-7xl items-start gap-12 px-4 sm:px-6 lg:grid-cols-[0.85fr_1fr] lg:px-8">
          <Reveal>
            <div className="overflow-hidden rounded-3xl shadow-elegant lg:sticky lg:top-28">
              <img
                src={PHOTOS.welcome}
                alt="St. Theresa's School of Novaliches campus"
          ...
          <Reveal delay={120}>
            <div>
              <SectionHeading align="left" eyebrow="Our Heritage" title="The Teresian Story" />
              ...
              <div className="mt-8 space-y-4 rounded-2xl border bg-muted/40 p-6">
                <p className="text-sm italic text-muted-foreground">
                  As a Christian school, the STSN upholds the Church's philosophy of education
                  expressed in the Declaration on Christian Education of Vatican II: "…a true
                  education aims at the formation of the human person in pursuit of his ultimate end
                  and the good of the societies of which he is a member."
                </p>
                <p className="text-sm italic text-muted-foreground">
                  As a Filipino school, the STSN upholds the educational provisions of the
                  Philippine Constitution: "…all educational institutions shall aim to inculcate
        ...
        <div className="mx-auto grid max-w-6xl gap-8 px-4 sm:px-6 lg:grid-cols-2 lg:px-8">
          <Reveal>
            <div className="h-full rounded-3xl border border-primary-foreground/15 bg-primary-foreground/5 p-8 backdrop-blur-sm">
              <span className="grid size-12 place-items-center rounded-2xl bg-gradient-gold text-gold-foreground">
                <Eye className="size-6" />
              </span>
              <h2 className="mt-5 font-display text-2xl font-semibold text-gold">Our Vision</h2>
              <p className="mt-3 text-primary-foreground/85">
                Enrich lives by providing, creatively enhancing, and sustaining quality education in
                a relevant collaborative global environment.
              </p>
            </div>
          </Reveal>
          <Reveal delay={120}>
            <div className="h-full rounded-3xl border border-primary-foreground/15 bg-primary-foreground/5 p-8 backdrop-blur-sm">
              ...
              <p className="mt-3 text-primary-foreground/85">
                Develop learners for global citizenship and leadership and the highest fulfillment
                of human potential through education and character formation.
              </p>
            </div>
          </Reveal>
        </div>
