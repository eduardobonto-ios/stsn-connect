  ...
  head: () => ({
    meta: [
      { title: "St. Theresa's School of Novaliches | Shaping Future Leaders" },
      {
        name: "description",
        content:
          "Quality Catholic education from Preschool to Senior High. Excellence in Education, Values Formation, and Faith. Enroll now for SY 2026–2027.",
      },
      { property: "og:title", content: "St. Theresa's School of Novaliches" },
      {
        property: "og:description",
        content: "Shaping Future Leaders — Excellence in Education, Values Formation, and Faith.",
      },
    ],
  }),
  component: Home,
  ...
  return (
    <>
      ...
      <section className="relative isolate flex min-h-[88vh] items-center overflow-hidden">
        <img
          src={heroImg}
          alt="Teresian students celebrating"
          className="absolute inset-0 -z-10 size-full object-cover animate-slow-zoom"
          width={1920}
          height={1080}
        />
      ...
      <section className="bg-muted/40 py-20">
        <div className="mx-auto grid max-w-7xl gap-8 px-4 sm:px-6 lg:grid-cols-2 lg:px-8">
          <Reveal>
            <div className="h-full rounded-2xl border bg-card p-8 shadow-soft">
              <div className="flex items-center gap-3 border-b pb-4">
                <span className="grid size-11 place-items-center rounded-xl bg-gradient-brown text-primary-foreground">
              ...
              <ul className="mt-5 divide-y">
                {ANNOUNCEMENTS.map((a) => (
                  <li key={a.title} className="py-4">
                    <h3 className="font-semibold text-gold-foreground">
                      <span className="text-gradient-gold">{a.title}</span>
                    </h3>
          ...
          <Reveal delay={120}>
            <div className="h-full rounded-2xl border bg-card p-8 shadow-soft">
              <div className="flex items-center gap-3 border-b pb-4">
                <span className="grid size-11 place-items-center rounded-xl bg-gradient-gold text-gold-foreground">
        ...
        <div className="mx-auto grid max-w-7xl items-center gap-12 px-4 sm:px-6 lg:grid-cols-2 lg:px-8">
          <Reveal>
            <div className="overflow-hidden rounded-3xl shadow-elegant">
              <img
                src={PHOTOS.welcome}
                alt="St. Theresa's School of Novaliches"
          ...
          <Reveal delay={120}>
            <div>
              ...
              <h2 className="mt-3 font-display text-3xl font-semibold sm:text-4xl">
                A community where dreams turn into reality
              </h2>
              <div className="mt-5 space-y-4 text-muted-foreground">
                <p>
                  Welcome to St. Theresa's School of Novaliches, home of learners, leaders, and
                  dreams turning into reality. Here, we ensure that every student receives quality
                  education, modern facilities, and a supportive community dedicated to helping them
                  grow.
                </p>
                <p>
                  At STSN, we don't just teach — we create opportunities. Through every classroom,
                  project, and program, our goal is to develop the skills and confidence students
                  need to succeed in the real world.
                </p>
                <p className="font-semibold text-foreground">
                  Welcome to St. Theresa's School of Novaliches — Your journey starts here!
                </p>
              </div>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <Reveal>
            <SectionHeading
              eyebrow="Academics"
              title="Our Programs"
              subtitle="A complete learning journey from early childhood to senior high school."
            />
          </Reveal>
              ...
              return (
                <Reveal key={v.title} delay={i * 90}>
                  <div className="h-full rounded-2xl border bg-card p-7 text-center shadow-soft">
                    <span className="mx-auto grid size-14 place-items-center rounded-2xl bg-gradient-brown text-primary-foreground">
                      <Icon className="size-6" />
                    </span>
                    <h3 className="mt-5 font-display text-xl font-semibold text-gradient-gold">
                      {v.title}
                    </h3>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <Reveal>
            <SectionHeading
              ...
              title="School Events"
              subtitle="Celebrating faith, talent, and Teresian spirit all year round."
            />
          </Reveal>
          <div className="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div className="mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8">
          <Reveal>
            ...
            <h2 className="mt-5 font-display text-3xl font-semibold sm:text-4xl">
              Begin your Teresian journey today
            </h2>
            <p className="mx-auto mt-3 max-w-xl text-primary-foreground/80">
              Admissions for School Year 2026–2027 are now open for New Students, Continuing
              Students, Returnees, and Transferees.
            </p>
