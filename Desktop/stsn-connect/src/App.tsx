  ...
  const sidebarItems = [
    {
      ...
      desc: "Live admissions & fees",
    },
    {
      id: "REGISTRAR",
      label: "Admissions & COR",
      icon: Compass,
      desc: "Student registrations",
    },
    {
      id: "ACCOUNTING",
      label: "Collections & Billing",
      icon: Coins,
      desc: "Tuple assessments ledger",
    },
    {
      id: "GRADING",
      label: "Grades Directory",
      icon: GraduationCap,
      desc: "Midterm/Final score encodes",
    },
    {
      id: "STUDENT_PORTAL",
      label: "Student Portal Room",
      icon: UserCheck,
      desc: "View grades, COR & ID",
    },
    {
      id: "FACULTY_PORTAL",
      label: "Teacher Board",
      icon: BookOpen,
      desc: "Schedules & class scores",
    },
    {
      id: "HR_MANAGEMENT",
    ...
    {
      id: "CURRICULUM",
      label: "Syllabus Pathways",
      icon: Building2,
      desc: "Academic subjects flow",
    },
    {
      id: "ACCOUNTS_SECURITY",
      label: "Authority Clearances",
      icon: Shield,
      desc: "Credential security status",
    },
  ] as const;

  const renderedSidebarItems = sidebarItems.filter((item) =>
      ...
      <aside className="hidden lg:flex flex-col w-[265px] h-full flex-shrink-0 relative sidebar-gradient">
        ...
        <div className="px-4 py-2.5 space-y-1.5 border-b border-white/5">
          <div className="flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg bg-white/5 border border-white/8">
            ...
            <span className="text-[8.5px] font-mono text-stone-300 truncate">
          ...
          <div className="flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg bg-blue-500/10 border border-blue-400/15">
            ...
            <span className="text-[8.5px] font-mono text-blue-300 truncate">
        ...
        <div className="p-4 border-t border-white/8">
          <button
            onClick={() => {
              logout();
              alert("Logged out of STSN Connect session.");
            }}
      ...
      <div className="flex-1 flex flex-col h-full overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto p-6 md:p-8 space-y-6 bg-gradient-to-br from-stsn-cream via-[#FAF6EE] to-[#F5F0E8]">
          {activeModule === "DASHBOARD" &&
            allowedModules.includes("DASHBOARD") && <Dashboard />}
