...
export const ROLE_PERMISSIONS: Record<CanonicalRole, Permission[]> = {
  ...
  "admin": ["MY_PROFILE", "DASHBOARD", "ACTION_CENTER", "STUDENT_DIRECTORY", "HR_MANAGEMENT", "REGISTRAR_REPORTS", "ADMIN_REPORTS", "GUARDIAN_PORTAL"],
  principal: ["MY_PROFILE", "ACTION_CENTER", "STUDENT_DIRECTORY", "GRADING", "CURRICULUM", "FACULTY_ADMIN", "SCHEDULING", "REGISTRAR_REPORTS"],
  registrar: ["MY_PROFILE", "ACTION_CENTER", "REGISTRAR", "STUDENT_DIRECTORY", "GRADING", "CURRICULUM", "FACULTY_ADMIN", "CLASS_SECTIONING", "BOOKS_SETUP", "REGISTRAR_REPORTS"],
