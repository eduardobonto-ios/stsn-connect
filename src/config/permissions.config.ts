...
export const ROLE_PERMISSIONS: Record<CanonicalRole, Permission[]> = {
  "super-admin": ["DASHBOARD", "REGISTRAR", "ACCOUNTING", "CASHIER", "BOOKS_SETUP", "GRADING", "CURRICULUM", "STUDENT_PORTAL", "FACULTY_PORTAL", "HR_MANAGEMENT", "ACCOUNTS_SECURITY", "CORE_SETUP", "SCHEDULING", "CLASS_SECTIONING", "ONLINE_LEARNING", "NURSE_CLINIC", "GUIDANCE", "CONSULTATION", "REGISTRAR_REPORTS"],
  registrar: ["DASHBOARD", "REGISTRAR", "CURRICULUM", "STUDENT_PORTAL", "SCHEDULING", "CLASS_SECTIONING", "BOOKS_SETUP", "GUIDANCE", "CONSULTATION", "REGISTRAR_REPORTS"],
