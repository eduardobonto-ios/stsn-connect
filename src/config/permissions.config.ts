...
export const ROLE_PERMISSIONS: Record<CanonicalRole, Permission[]> = {
  "super-admin": ["DASHBOARD", "REGISTRAR", "STUDENT_DIRECTORY", "ACCOUNTING", "CASHIER", "BOOKS_SETUP", "GRADING", "CURRICULUM", "STUDENT_PORTAL", "FACULTY_PORTAL", "FACULTY_ADMIN", "HR_MANAGEMENT", "PAYROLL_MANAGEMENT", "ACCOUNTS_SECURITY", "CORE_SETUP", "SCHEDULING", "CLASS_SECTIONING", "ONLINE_LEARNING", "NURSE_CLINIC", "GUIDANCE", "CONSULTATION", "REGISTRAR_REPORTS", "GUIDANCE_REPORTS", "CLINIC_REPORTS", "ADMIN_REPORTS"],
  principal: ["DASHBOARD", "STUDENT_DIRECTORY", "GRADING", "CURRICULUM", "FACULTY_ADMIN", "SCHEDULING", "REGISTRAR_REPORTS"],
  registrar: ["DASHBOARD", "REGISTRAR", "STUDENT_DIRECTORY", "GRADING", "CURRICULUM", "STUDENT_PORTAL", "FACULTY_ADMIN", "CLASS_SECTIONING", "BOOKS_SETUP", "GUIDANCE", "CONSULTATION", "REGISTRAR_REPORTS"],
