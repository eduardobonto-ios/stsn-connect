...
export const ROLE_PERMISSIONS: Record<CanonicalRole, Permission[]> = {
  ...
  principal: ["MY_PROFILE", "ACTION_CENTER", "STUDENT_DIRECTORY", "GRADING", "CURRICULUM", "FACULTY_ADMIN", "SCHEDULING", "LMS", "REGISTRAR_REPORTS"],
  registrar: ["MY_PROFILE", "ACTION_CENTER", "REGISTRAR", "STUDENT_DIRECTORY", "GRADING", "CURRICULUM", "FACULTY_ADMIN", "CLASS_SECTIONING", "BOOKS_SETUP", "LIBRARY_SYSTEM", "LMS", "REGISTRAR_REPORTS"],
  accounting: ["MY_PROFILE", "ACTION_CENTER", "ACCOUNTING", "BOOKS_SETUP"],
  cashier: ["MY_PROFILE", "CASHIER"],
  teacher: ["MY_PROFILE", "FACULTY_PORTAL", "GRADING", "CURRICULUM", "LMS"],
  student: ["MY_PROFILE", "STUDENT_PORTAL", "LMS", "CONSULTATION"],
