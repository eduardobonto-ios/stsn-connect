...
export const ROLE_PERMISSIONS: Record<CanonicalRole, Permission[]> = {
  ...
  registrar: ["ACTION_CENTER", "REGISTRAR", "STUDENT_DIRECTORY", "GRADING", "CURRICULUM", "STUDENT_PORTAL", "FACULTY_ADMIN", "CLASS_SECTIONING", "BOOKS_SETUP", "GUIDANCE", "CONSULTATION", "REGISTRAR_REPORTS"],
