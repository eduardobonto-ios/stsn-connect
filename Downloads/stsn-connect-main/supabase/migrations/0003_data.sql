...
insert into public.setup_items (legacy_id, category, code, name, description, is_active, sort_order, metadata, created_by, created_at) values
  ...
  -- Basic Education tuition fee items mapped by year level (Nursery → Grade 12)
  -- yearLevel stores the year_levels.code value; amounts match tuition_fee_schedule
  ('fi-7',  'fee_items', 'TUI-NURS', 'Tuition Fee - Nursery',  'Basic Ed tuition for Nursery',        true, 10, '{"categoryId":"fc-1","amount":10500,"yearLevel":"NURS"}'::jsonb, 'Admin Administrator', '2026-01-01'),
  ('fi-8',  'fee_items', 'TUI-K1',   'Tuition Fee - Kinder 1', 'Basic Ed tuition for Kinder 1',       true, 11, '{"categoryId":"fc-1","amount":11000,"yearLevel":"K1"}'::jsonb,   'Admin Administrator', '2026-01-01'),
  ('fi-9',  'fee_items', 'TUI-K2',   'Tuition Fee - Kinder 2', 'Basic Ed tuition for Kinder 2',       true, 12, '{"categoryId":"fc-1","amount":11500,"yearLevel":"K2"}'::jsonb,   'Admin Administrator', '2026-01-01'),
  ('fi-10', 'fee_items', 'TUI-G1',   'Tuition Fee - Grade 1',  'Basic Ed tuition for Grade 1',        true, 13, '{"categoryId":"fc-1","amount":14000,"yearLevel":"G1"}'::jsonb,   'Admin Administrator', '2026-01-01'),
  ('fi-11', 'fee_items', 'TUI-G2',   'Tuition Fee - Grade 2',  'Basic Ed tuition for Grade 2',        true, 14, '{"categoryId":"fc-1","amount":14000,"yearLevel":"G2"}'::jsonb,   'Admin Administrator', '2026-01-01'),
  ('fi-12', 'fee_items', 'TUI-G3',   'Tuition Fee - Grade 3',  'Basic Ed tuition for Grade 3',        true, 15, '{"categoryId":"fc-1","amount":14500,"yearLevel":"G3"}'::jsonb,   'Admin Administrator', '2026-01-01'),
  ('fi-13', 'fee_items', 'TUI-G4',   'Tuition Fee - Grade 4',  'Basic Ed tuition for Grade 4',        true, 16, '{"categoryId":"fc-1","amount":15000,"yearLevel":"G4"}'::jsonb,   'Admin Administrator', '2026-01-01'),
  ('fi-14', 'fee_items', 'TUI-G5',   'Tuition Fee - Grade 5',  'Basic Ed tuition for Grade 5',        true, 17, '{"categoryId":"fc-1","amount":15000,"yearLevel":"G5"}'::jsonb,   'Admin Administrator', '2026-01-01'),
  ('fi-15', 'fee_items', 'TUI-G6',   'Tuition Fee - Grade 6',  'Basic Ed tuition for Grade 6',        true, 18, '{"categoryId":"fc-1","amount":15500,"yearLevel":"G6"}'::jsonb,   'Admin Administrator', '2026-01-01'),
  ('fi-16', 'fee_items', 'TUI-G7',   'Tuition Fee - Grade 7',  'Basic Ed tuition for Grade 7',        true, 19, '{"categoryId":"fc-1","amount":17000,"yearLevel":"G7"}'::jsonb,   'Admin Administrator', '2026-01-01'),
  ('fi-17', 'fee_items', 'TUI-G8',   'Tuition Fee - Grade 8',  'Basic Ed tuition for Grade 8',        true, 20, '{"categoryId":"fc-1","amount":17000,"yearLevel":"G8"}'::jsonb,   'Admin Administrator', '2026-01-01'),
  ('fi-18', 'fee_items', 'TUI-G9',   'Tuition Fee - Grade 9',  'Basic Ed tuition for Grade 9',        true, 21, '{"categoryId":"fc-1","amount":17500,"yearLevel":"G9"}'::jsonb,   'Admin Administrator', '2026-01-01'),
  ('fi-19', 'fee_items', 'TUI-G10',  'Tuition Fee - Grade 10', 'Basic Ed tuition for Grade 10',       true, 22, '{"categoryId":"fc-1","amount":17500,"yearLevel":"G10"}'::jsonb,  'Admin Administrator', '2026-01-01'),
  ('fi-20', 'fee_items', 'TUI-G11',  'Tuition Fee - Grade 11', 'Basic Ed tuition for Grade 11 (SHS)', true, 23, '{"categoryId":"fc-1","amount":18500,"yearLevel":"G11"}'::jsonb,  'Admin Administrator', '2026-01-01'),
  ('fi-21', 'fee_items', 'TUI-G12',  'Tuition Fee - Grade 12', 'Basic Ed tuition for Grade 12 (SHS)', true, 24, '{"categoryId":"fc-1","amount":18500,"yearLevel":"G12"}'::jsonb,  'Admin Administrator', '2026-01-01'),
...
insert into public.curriculum_subjects (curriculum_id, subject_id, year_level, semester) values
  ((select id from public.curriculums where legacy_id = 'curr-stem'), (select id from public.subjects where legacy_id = 'SHS-ORAL-COM'), 'Grade 11', 'First Semester'),
  ((select id from public.curriculums where legacy_id = 'curr-stem'), (select id from public.subjects where legacy_id = 'SHS-READ-WRITE'), 'Grade 11', 'First Semester'),
  ((select id from public.curriculums where legacy_id = 'curr-stem'), (select id from public.subjects where legacy_id = 'SHS-GEN-MATH'), 'Grade 11', 'First Semester'),
  ((select id from public.curriculums where legacy_id = 'curr-stem'), (select id from public.subjects where legacy_id = 'SHS-STAT-PROB'), 'Grade 11', 'First Semester'),
  ((select id from public.curriculums where legacy_id = 'curr-stem'), (select id from public.subjects where legacy_id = 'SHS-EARTH-LIFE'), 'Grade 11', 'First Semester'),
  ((select id from public.curriculums where legacy_id = 'curr-stem'), (select id from public.subjects where legacy_id = 'SHS-PHYS-SCI'), 'Grade 11', 'Second Semester'),
  ((select id from public.curriculums where legacy_id = 'curr-stem'), (select id from public.subjects where legacy_id = 'SHS-PER-DEV'), 'Grade 11', 'Second Semester'),
  ((select id from public.curriculums where legacy_id = 'curr-humss'), (select id from public.subjects where legacy_id = 'SHS-HUMSS-PCOM'), 'Grade 11', 'First Semester'),
  ((select id from public.curriculums where legacy_id = 'curr-humss'), (select id from public.subjects where legacy_id = 'SHS-HUMSS-CW'), 'Grade 11', 'First Semester'),
  ((select id from public.curriculums where legacy_id = 'curr-humss'), (select id from public.subjects where legacy_id = 'SHS-HUMSS-DISP'), 'Grade 11', 'First Semester'),
  ((select id from public.curriculums where legacy_id = 'curr-abm'), (select id from public.subjects where legacy_id = 'SHS-ABM-OBA'), 'Grade 11', 'First Semester'),
  ((select id from public.curriculums where legacy_id = 'curr-abm'), (select id from public.subjects where legacy_id = 'SHS-ABM-PRIN'), 'Grade 11', 'First Semester'),
  ((select id from public.curriculums where legacy_id = 'curr-abm'), (select id from public.subjects where legacy_id = 'SHS-ABM-BM'), 'Grade 12', 'First Semester'),
  ((select id from public.curriculums where legacy_id = 'curr-abm'), (select id from public.subjects where legacy_id = 'SHS-ABM-ECON'), 'Grade 12', 'First Semester'),
  ((select id from public.curriculums where legacy_id = 'curr-bsit'), (select id from public.subjects where legacy_id = 'IT101'), '1st Year', 'First Semester'),
  ((select id from public.curriculums where legacy_id = 'curr-bsit'), (select id from public.subjects where legacy_id = 'IT102'), '1st Year', 'First Semester'),
  ((select id from public.curriculums where legacy_id = 'curr-bsit'), (select id from public.subjects where legacy_id = 'MATH101'), '1st Year', 'First Semester'),
  ((select id from public.curriculums where legacy_id = 'curr-bsit'), (select id from public.subjects where legacy_id = 'NSTP1'), '1st Year', 'First Semester'),
  ((select id from public.curriculums where legacy_id = 'curr-bsit'), (select id from public.subjects where legacy_id = 'IT103'), '1st Year', 'Second Semester'),
  ((select id from public.curriculums where legacy_id = 'curr-bsit'), (select id from public.subjects where legacy_id = 'IT104'), '1st Year', 'Second Semester'),
  ((select id from public.curriculums where legacy_id = 'curr-bsit'), (select id from public.subjects where legacy_id = 'IT201'), '2nd Year', 'First Semester'),
  ((select id from public.curriculums where legacy_id = 'curr-bsit'), (select id from public.subjects where legacy_id = 'IT202'), '2nd Year', 'First Semester'),
  ((select id from public.curriculums where legacy_id = 'curr-bsit'), (select id from public.subjects where legacy_id = 'IT301'), '3rd Year', 'First Semester'),
  ((select id from public.curriculums where legacy_id = 'curr-bsit'), (select id from public.subjects where legacy_id = 'IT302'), '3rd Year', 'First Semester'),
  ((select id from public.curriculums where legacy_id = 'curr-bscs'), (select id from public.subjects where legacy_id = 'CS101'), '1st Year', 'First Semester'),
  ((select id from public.curriculums where legacy_id = 'curr-bscs'), (select id from public.subjects where legacy_id = 'CS102'), '1st Year', 'First Semester'),
  ((select id from public.curriculums where legacy_id = 'curr-bscs'), (select id from public.subjects where legacy_id = 'CS103'), '1st Year', 'First Semester'),
  ((select id from public.curriculums where legacy_id = 'curr-bscs'), (select id from public.subjects where legacy_id = 'CS201'), '2nd Year', 'First Semester'),
  ((select id from public.curriculums where legacy_id = 'curr-bsba'), (select id from public.subjects where legacy_id = 'BA101'), '1st Year', 'First Semester'),
  ((select id from public.curriculums where legacy_id = 'curr-bsba'), (select id from public.subjects where legacy_id = 'BA102'), '1st Year', 'First Semester'),
  ((select id from public.curriculums where legacy_id = 'curr-bsba'), (select id from public.subjects where legacy_id = 'MATH102'), '1st Year', 'First Semester'),
  ((select id from public.curriculums where legacy_id = 'curr-bsba'), (select id from public.subjects where legacy_id = 'BA201'), '2nd Year', 'First Semester'),
  ((select id from public.curriculums where legacy_id = 'curr-bsba'), (select id from public.subjects where legacy_id = 'BA202'), '2nd Year', 'First Semester'),
  ((select id from public.curriculums where legacy_id = 'curr-bsa'), (select id from public.subjects where legacy_id = 'ACCT101'), '1st Year', 'First Semester'),
  ((select id from public.curriculums where legacy_id = 'curr-bsa'), (select id from public.subjects where legacy_id = 'ACCT102'), '1st Year', 'Second Semester'),
  ((select id from public.curriculums where legacy_id = 'curr-bsa'), (select id from public.subjects where legacy_id = 'ACCT201'), '2nd Year', 'First Semester'),
  ((select id from public.curriculums where legacy_id = 'curr-bshm'), (select id from public.subjects where legacy_id = 'HM101'), '1st Year', 'First Semester'),
  ((select id from public.curriculums where legacy_id = 'curr-bshm'), (select id from public.subjects where legacy_id = 'HM102'), '1st Year', 'First Semester'),
  ((select id from public.curriculums where legacy_id = 'curr-bshm'), (select id from public.subjects where legacy_id = 'HM103'), '1st Year', 'Second Semester'),
  ((select id from public.curriculums where legacy_id = 'curr-bsed'), (select id from public.subjects where legacy_id = 'ED101'), '1st Year', 'First Semester'),
  ((select id from public.curriculums where legacy_id = 'curr-bsed'), (select id from public.subjects where legacy_id = 'ED102'), '1st Year', 'First Semester'),
  ((select id from public.curriculums where legacy_id = 'curr-bsed'), (select id from public.subjects where legacy_id = 'ED401'), '4th Year', 'First Semester'),
  ((select id from public.curriculums where legacy_id = 'curr-bsed'), (select id from public.subjects where legacy_id = 'ED402'), '4th Year', 'First Semester')
on conflict do nothing;
...
insert into public.enrollment_subjects (enrollment_id, subject_id) values
  ((select id from public.enrollments where legacy_id = 'enr-01'), (select id from public.subjects where legacy_id = 'SHS-ORAL-COM')),
  ((select id from public.enrollments where legacy_id = 'enr-01'), (select id from public.subjects where legacy_id = 'SHS-READ-WRITE')),
  ((select id from public.enrollments where legacy_id = 'enr-01'), (select id from public.subjects where legacy_id = 'SHS-GEN-MATH')),
  ((select id from public.enrollments where legacy_id = 'enr-01'), (select id from public.subjects where legacy_id = 'SHS-STAT-PROB')),
  ((select id from public.enrollments where legacy_id = 'enr-01'), (select id from public.subjects where legacy_id = 'SHS-EARTH-LIFE')),
  ((select id from public.enrollments where legacy_id = 'enr-02'), (select id from public.subjects where legacy_id = 'IT101')),
  ((select id from public.enrollments where legacy_id = 'enr-02'), (select id from public.subjects where legacy_id = 'IT102')),
  ((select id from public.enrollments where legacy_id = 'enr-02'), (select id from public.subjects where legacy_id = 'MATH101')),
  ((select id from public.enrollments where legacy_id = 'enr-02'), (select id from public.subjects where legacy_id = 'NSTP1')),
  ((select id from public.enrollments where legacy_id = 'enr-03'), (select id from public.subjects where legacy_id = 'SHS-ABM-OBA')),
  ((select id from public.enrollments where legacy_id = 'enr-03'), (select id from public.subjects where legacy_id = 'SHS-ABM-PRIN')),
  ((select id from public.enrollments where legacy_id = 'enr-04'), (select id from public.subjects where legacy_id = 'SHS-HUMSS-PCOM')),
  ((select id from public.enrollments where legacy_id = 'enr-04'), (select id from public.subjects where legacy_id = 'SHS-HUMSS-CW')),
  ((select id from public.enrollments where legacy_id = 'enr-04'), (select id from public.subjects where legacy_id = 'SHS-HUMSS-DISP')),
  ((select id from public.enrollments where legacy_id = 'enr-05'), (select id from public.subjects where legacy_id = 'BA201')),
  ((select id from public.enrollments where legacy_id = 'enr-05'), (select id from public.subjects where legacy_id = 'BA202'))
on conflict do nothing;
